	    	...
	    	switch ($command) {
	    		...
	    		case 'delete':
	   			...
	   			case 'select':
    				...
    				elseif($changetag=='All'){
	   					$result=$do->getAllToUber();
    				}
	   				else{
    			...
    			case 'update':
    				if($changetag=='postCheck'){
    					$result=$do->changepostChecktoUber($contents,$changeparam1,$changeparam2);
    				}
    				elseif($changetag=='Uber'){
	    				$result=$do->changeUbertoUber($contents,$changeparam1,$changeparam2);
    				}
    				elseif($changetag=='deliveryCheck'){
    					$result=$do->changedeliveryChecktoUber($contents,$changeparam1,$changeparam2);
    				}
    				else{
    					$result=='error : check change tage';
    				}
    				break;
	   			default:
